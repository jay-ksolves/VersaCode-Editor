  ...
  return (
    <div className="prose dark:prose-invert max-w-none animate-fade-in">
      ...
      <article className="mb-12 animate-slide-up" style={{ animationDelay: '0.3s' }}>
        <h2 className="text-2xl font-semibold tracking-tight mb-2">The Vision for VersaCode: An AI-Native IDE</h2>
      ...
      <article className="animate-slide-up" style={{ animationDelay: '0.4s' }}>
        <h2 className="text-2xl font-semibold tracking-tight mb-2">Under the Hood: Building a Web IDE with Next.js and Monaco</h2>
